...
public class Main {
    public static void main(String[] args) {
        ...
        // Те, кто младше 18.
        long teenagersUnder18 = persons.stream().filter(person -> person.getAge() < 18).count();

        // Список мужчин от 18 и до 27 лет
        List<String> whoCanBeASoldier = persons.stream().filter(person -> (person.getAge() >= 18 && person.getAge() <= 27))
